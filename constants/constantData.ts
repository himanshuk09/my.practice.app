...
export const AccordionData = [
	...
	},
	{
		...
		details: [
			{
				id: 1,
				channel: "Werk I - Virtuell (Summe aus Bilstein Im Weinhof + Färberstr.) | MaLo: 50603374899 | Quelle: Kunde",
				route: "/dashboard/loaddata/1",
			},
			{
				id: 2,
				channel: "Werk II - Oeger Str. 11-35 | MaLo: 50601507997 | Quelle: Kunde",
